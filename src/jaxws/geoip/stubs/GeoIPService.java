    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(jaxws.geoip.stubs.GeoIPService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = jaxws.geoip.stubs.GeoIPService.class.getResource(".");
